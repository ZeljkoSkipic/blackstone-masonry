...
function register_acf_blocks() {
	...
	register_block_type( __DIR__ . '/../blocks/overlap-images' );
	register_block_type( __DIR__ . '/../blocks/inner-hero' );
	register_block_type( __DIR__ . '/../blocks/bottom-right-boxes' );
	register_block_type( __DIR__ . '/../blocks/half-thirds-text' );
	register_block_type( __DIR__ . '/../blocks/cta' );
	register_block_type( __DIR__ . '/../blocks/portfolio-gallery' );
