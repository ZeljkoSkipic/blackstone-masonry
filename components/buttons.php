...
$email_switch = get_field('mail_btn_switch');
$phone_switch = get_field('phone_btn_switch');


if( !empty($btn1 || $btn2 || $phone_switch ||$email_switch ) ) { ?>
...
<?php
if( $email_switch ) { ?>
	<a class="btn email_btn" href="mailto:<?php echo $email; ?>"><?php echo $email; ?></a>
<?php } ?>

<?php
if( $phone_switch ) { ?>
	<a class="btn phone_btn" href="tel:<?php echo $phone; ?>"><?php echo $phone; ?></a>
<?php } ?>
